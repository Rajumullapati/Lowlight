...
def run_cnn():
    ...
    writer = tf.summary.FileWriter('C:\\Users\\HWRacing\\TensorTest\\printing_test')
    with tf.Session() as sess:
        ...
        for epoch in range(epochs):
            ...
            summary = sess.run(merged, feed_dict={x: mnist.validation.images, y: mnist.validation.labels})
        ...
        print(prediction.eval(feed_dict={mnist.validation.images}, session=sess))
